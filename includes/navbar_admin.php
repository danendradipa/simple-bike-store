...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark p-3">
    <div class="container">
      <a class="navbar-brand" href="dashboard_admin.php">Admin Panel</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto d-flex align-items-center"> <!-- Mengganti ml-auto dengan ms-auto untuk Bootstrap 5 -->
          ...
          <li class="nav-item me-3">
            <a class="nav-link text-white" href="dashboard_admin.php">Dashboard</a> <!-- Menambahkan kelas text-white -->
          </li>
          <li class="nav-item me-3">
            <a class="nav-link text-white" href="data_sepeda.php">Kelola Sepeda</a> <!-- Menambahkan kelas text-white -->
          </li>
          <li class="nav-item me-3">
            <a class="nav-link text-white" href="view_chatbot.php">Kelola Chatbot</a> <!-- Menambahkan kelas text-white -->
          </li>
          <li class="nav-item">
